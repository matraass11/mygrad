...
class TensorBaseUntemplated {};

template<size_t length, uint dimensionality>
class TensorMatrixProduct;

template <size_t length, uint dimensionality>
class TensorBase : public TensorBaseUntemplated {    
protected:
...
TensorBaseUntemplated matMul2d(const TensorBaseUntemplated& other) const {
...
public:
    TensorMatrixProduct(const std::array<double, length>& dataArray, const std::array<uint, dimensionality>& dimensions, 
                        const TensorBaseUntemplated* parent1, const TensorBaseUntemplated* parent2) 
